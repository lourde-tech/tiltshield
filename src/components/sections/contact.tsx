  ...
  return (
    <section id="contact" className="relative bg-ink py-24 md:py-32">
      <div className="container grid gap-14 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
        <FadeUp>
          <p className="spec-label text-cyan">Request pricing</p>
          ...
          <p className="mt-5 max-w-md text-lg leading-relaxed text-slateSoft">
            Share a few details and we'll follow up with pricing and next steps
            — usually within one business day.
          </p>

          <ul className="mt-10 space-y-5">
            <li>
              <a href="tel:+18339876455" className="group flex items-center gap-4 text-coolGray transition-colors hover:text-cyan">
                <span className="grid h-11 w-11 place-items-center rounded-xl border border-graphite bg-white/[0.04]">
                  <Phone className="h-5 w-5 text-cyan" strokeWidth={1.8} aria-hidden="true" />
                </span>
                (833) 987-6455
              </a>
            </li>
            <li>
              <a href="mailto:info@tiltshield.com" className="group flex items-center gap-4 text-coolGray transition-colors hover:text-cyan">
                <span className="grid h-11 w-11 place-items-center rounded-xl border border-graphite bg-white/[0.04]">
                  <Mail className="h-5 w-5 text-cyan" strokeWidth={1.8} aria-hidden="true" />
                </span>
                info@tiltshield.com
              </a>
            </li>
            <li>
              <a href="https://www.tiltshieldusa.com" className="group flex items-center gap-4 text-coolGray transition-colors hover:text-cyan">
                <span className="grid h-11 w-11 place-items-center rounded-xl border border-graphite bg-white/[0.04]">
                  <Globe className="h-5 w-5 text-cyan" strokeWidth={1.8} aria-hidden="true" />
                </span>
                www.tiltshieldusa.com
              </a>
            </li>
          </ul>
        </FadeUp>
            ...
            <div className="rounded-[calc(2rem-0.5rem)] border border-white/5 bg-navy/60 p-6 md:p-9">
              {submitted ? (
                <div className="flex min-h-[420px] flex-col items-center justify-center text-center">
                  <span className="grid h-16 w-16 place-items-center rounded-full bg-compliance/15">
                    <CheckCircle2 className="h-8 w-8 text-compliance" aria-hidden="true" />
                  </span>
